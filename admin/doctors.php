...
<body>
    ...
    <div class="container">
        <div class="menu">
            <div class="menu-container" border="0">
                    <div class="menu-btn menu-icon-dashbord" >
                        <a href="index.php" class="non-style-link-menu"><div><p class="menu-text">Dashboard</p></a></div></a>
                    </div>
                    <div class="menu-btn menu-icon-doctor menu-active menu-icon-doctor-active">
                    ...
                    <div style="padding:10px" colspan="2">
                        <div border="0" class="profile-container">
                                <!-- <div width="30%" style="padding-left:20px" >
                                    <img src="../img/user.png" width="20%" style="border-radius:50%">
                                </div> -->
                                <div style="padding:0px;margin:0px;">   
                                <p class="profile-title"><img src="../img/user.png" width="20%" style="border-radius:50%">Administrator</p>
